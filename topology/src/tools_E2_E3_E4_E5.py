...
# Computing the full T and E correlations
# This is used in E2, E3, E4, and E5
    ...
    for i in range(eig_num):
      ...
      for l in range(min_ell, max_ell + 1):
        ...
        for l_p in range(l_start, ell_p_range[1]+1):
          ...
          ell_ell_p_integ_TT = integrand[0, k_unique_index_cur, l, l_p] * ipow[(l - l_p)%4]
          ell_ell_p_integ_EE = (
          ...
          for m in range(-l, l + 1):
            ...
            for m_p in range(0, l_p + 1):
              ...
              C_lmlpmp[0, lm_index_cur, lm_p_index_cur] += ell_ell_p_integ_TT * Xi
              C_lmlpmp[1, lm_index_cur, lm_p_index_cur] += ell_ell_p_integ_EE * Xi
              C_lmlpmp[2, lm_index_cur, lm_p_index_cur] += ell_ell_p_integ_TE * Xi
              if l != l_p:
              # TE correlations
                C_lmlpmp[2, lm_p_index_cur, lm_index_cur] += ell_p_ell_integ_TE * conjugate(Xi)
